 ...
 * 时间滑动窗口示例
 */
public class SlidingTimeWindowsDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 5. 开窗 - 滑动窗口，间隔为10秒，步长为5秒
        WindowedStream<ServerInfo, String, TimeWindow> windowStream = kyStream.window(SlidingProcessingTimeWindows.of(Duration.ofSeconds(10),Duration.ofSeconds(5)));
        // 6. 计算
