 ...
 * 时间会话窗口演示
 */
public class SessionTimeWindowsDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 5. 开窗
        WindowedStream<ServerInfo, String, TimeWindow> windowStream = kyStream.window(
                // 固定间隔时间
                ProcessingTimeSessionWindows.withGap(Duration.ofSeconds(10))
                // 动态间隔时间
