package com.demo.lesson09.definition;
...
public class WatermarkCustomDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 4. 使用自定义watermark以及TimestampAssigner
        WatermarkStrategy<ServerInfo> watermarkStrategy = WatermarkStrategy
                // 设置乱序watermark，需要指定水位线延迟时间，设置2秒
                .<ServerInfo>forGenerator((ctx) -> new CustomWatermarkGenerator<>(Duration.ofSeconds(2)))
                // 设置事件时间处理器
